...
if (empty($search)) {
    Massage::set_Massages("error", "Please enter a search term");
    header('Location: index.php?page=All_Blogs');
    exit;
}
                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            <li>Search Results: <?php echo $search; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="blog_sidebar_widget">
                        <div class="widget_list widget_search">
                            <h3>Search</h3>
                            <form action="index.php?page=blog_search" method="GET">
