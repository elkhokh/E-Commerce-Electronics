			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<a href="index.php?page=home" class="brand-link">
					<img src="public/assets/dashboard/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				...
				<div class="sidebar">
					...
					<nav class="mt-2">
						<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="index.php?page=offers" class="nav-link">
							...
							<li class="nav-item">
								<a href="index.php?page=error" class="nav-link">
